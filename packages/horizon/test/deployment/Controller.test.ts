...
describe('Controller', function () {
  it('should have GraphToken registered', async function () {
    const graphToken = await Controller.getContractProxy(keccak256(toUtf8Bytes('GraphToken')))
  ...
  it('should have HorizonStaking registered', async function () {
    const horizonStaking = await Controller.getContractProxy(keccak256(toUtf8Bytes('Staking')))
  ...
  testIf(2)('should have GraphPayments registered', async function () {
    const graphPayments = await Controller.getContractProxy(keccak256(toUtf8Bytes('GraphPayments')))
  ...
  testIf(2)('should have PaymentsEscrow registered', async function () {
    const paymentsEscrow = await Controller.getContractProxy(keccak256(toUtf8Bytes('PaymentsEscrow')))
  ...
  it('should have EpochManager registered', async function () {
    const epochManager = await Controller.getContractProxy(keccak256(toUtf8Bytes('EpochManager')))
  ...
  it('should have RewardsManager registered', async function () {
    const rewardsManager = await Controller.getContractProxy(keccak256(toUtf8Bytes('RewardsManager')))
  ...
  it('should have GraphTokenGateway registered', async function () {
    const graphTokenGateway = await Controller.getContractProxy(keccak256(toUtf8Bytes('GraphTokenGateway')))
  ...
  testIf(2)('should have GraphProxyAdmin registered', async function () {
    const graphProxyAdmin = await Controller.getContractProxy(keccak256(toUtf8Bytes('GraphProxyAdmin')))
  ...
  it('should have Curation registered', async function () {
    const curation = await Controller.getContractProxy(keccak256(toUtf8Bytes('Curation')))
